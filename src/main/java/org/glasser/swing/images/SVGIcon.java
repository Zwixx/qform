package org.glasser.swing.images;
/*
 * SVGIcon.java
 *
...
public class SVGIcon extends UserAgentAdapter implements Icon {
	 ...
	 * Create a new SVGIcon object.
	 * 
	 * @param stream The Stream to read the SVG document from.
	 * @param w   The width of the icon.
	 * @param h   The height of the icon.
	 */
	public SVGIcon(InputStream stream, int w, int h) throws TranscoderException {
		generateBufferedImage(new TranscoderInput(stream), w, h);
	}
