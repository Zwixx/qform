...
public class ThirdPartyLafDialog extends JDialog implements ActionListener {
	...
	String prompt = "Enter the fully-qualified class name of the Look and Feel class you "
	...
	public ThirdPartyLafDialog(Frame parent) {
		...
		promptDisplay = new JTextArea() {
			public void updateUI() {
				...
				if (background != null) {
					if (debug)
						System.out.println("promptDisplay: using Panel.background.");
					...
					if (parent != null) {
						...
						if (background != null) {
							if (debug)
								System.out.println("promptDisplay: using parent.getBackground(): " + background);
							setBackground(background);
						}
					}
				}
	...
	public void setVisible(boolean b) {
		if (b)
			throw new RuntimeException("ThirdPartyLafDialog must be opened with the openDialog() method.");
	}
