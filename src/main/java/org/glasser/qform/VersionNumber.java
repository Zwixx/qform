...
public class VersionNumber implements java.io.Serializable {
	...
	static {
		// initializing VERSION_NUMBER here insures that the class will always
		// be loaded and VERSION_NUMBER will be dynamically, rather than
		// statically linked. (Hopefully.)
		VERSION_NUMBER = "1.4";
