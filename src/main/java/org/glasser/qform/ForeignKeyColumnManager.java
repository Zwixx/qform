...
import org.glasser.swing.table.AbstractColumnManager;

/**
 * This ColumnManager is used for the Foreign Key Columns table on a Foreign
 * Keys panel.
 */
public class ForeignKeyColumnManager extends AbstractColumnManager {

	protected final static String[] COLUMN_NAMES = { "Key Seq", "Local Column", "Data Type", "SQL Type", "Nullable",
			"Foreign Column" };

	protected final static Class<?>[] COLUMN_CLASSES = { Integer.class, String.class, String.class, Integer.class,
